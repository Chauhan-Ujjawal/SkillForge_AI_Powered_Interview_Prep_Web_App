...
const SummaryCard=({
    ...
    return (
    <div className="bg-white border border-gray-300/40 rounded-xl p-2 overflow-hidden cursor-pointer relative group transition-shadow duration-300 hover:shadow-2xl hover:shadow-black/60">
      <div
      ...
      >
        <div className="flex items-start">
          <div className="flex-shrink-0 w-14 h-14 bg-white rounded-md flex items-center justify-center mr-4">
