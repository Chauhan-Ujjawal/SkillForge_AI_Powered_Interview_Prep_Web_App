...
import AIResponsePreview from "../../pages/InterviewPrep/components/AIResponsivePreview";
...
function QuestionCard({
  ...
  return (
    <>
      <div className="bg-white rounded-lg mb-4 overflow-hidden py-4 px-5 shadow-lg shadow-black/25 hover:shadow-black/60 border border-gray-200 group transition-all duration-300">
